            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/index"><i class="fa fa-dashboard fa-fw"></i> 로그인</a>
                        ...
                        <li>
                            <a href="/reserve/selectApart?keyword="><i class="fa fa-table fa-fw"></i>예약(user)</a>
                        </li>
                        <li>
                            <a href="/board/list"><i class="fa fa-edit fa-fw"></i> 게시판</a>
                        </li>
						<li>
                            <a href="/reserve/myreserve"><i class="fa fa-edit fa-fw"></i> 내 예약현황</a>
                        </li>
